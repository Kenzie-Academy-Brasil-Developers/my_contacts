...
export class CreateDatabase1706534410209 implements MigrationInterface {
    name = 'CreateDatabase1706534410209'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "contact" ("id" SERIAL NOT NULL, "name" character varying(120) NOT NULL, "email" character varying(80) NOT NULL, "telephone" character varying(11) NOT NULL, "userId" integer, CONSTRAINT "PK_2cbbe00f59ab6b3bb5b8d19f989" PRIMARY KEY ("id"))`);
